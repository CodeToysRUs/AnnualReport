  ...
  <div class="result-page">
    ...
    <div class="result-page-top">
      <div class="result-page-top-left">
        ...
        <div class="result-page-top-left-bottom">微信公众号<img src="../../assets/icon/weChat.png" alt=""></div>
      </div>
      ...
      <div class="result-page-middle-bottom">
        ...
        <div class="result-page-middle-bottom-container">
          <div class="result-page-middle-bottom-top-border">
            ...
            <div class="result-page-top-border-text"><span>短文案短文案短文案</span></div>
          </div>
    ...
    <div class="result-page-button">
      ...
      <div class="result-page-button-right">分享图片</div>
    </div>
  </div>
</template>
<script>
